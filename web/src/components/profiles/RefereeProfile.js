...
function RefereeProfile() {
  const [formData, setFormData] = useState({
    ...
    twitter: '',
    linkedin: '',
    type: 'REFEREE',  // Added to specify the user type
  });
  ...
  return (
    <div className="referee-profile-container">
      <div className='referee-profile-header'>
        {t('referee_profile_information')}
      </div>
      <form className="referee-profile-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          <label className="mandatory">{t('referee_license_level')}</label>
          <input type="text" name="licenseLevel" value={formData.licenseLevel} onChange={handleChange} required />
        </div>
        <div className="form-group">
